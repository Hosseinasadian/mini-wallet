...
func RegisterHandler(c *gin.Context) {
	...
	emailRegex := regexp.MustCompile(`^[1780407118_create_auth_outbox_events_table.up.sql-z0-9._%+\-]+@[1780407118_create_auth_outbox_events_table.up.sql-z0-9.\-]+\.[1780407118_create_auth_outbox_events_table.up.sql-z]{2,4}$`)
