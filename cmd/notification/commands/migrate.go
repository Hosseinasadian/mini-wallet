...
var migrateCmd = &cobra.Command{
	Use:   "migrate",
	Short: "Migrate User Notification Service",
}
...
func migrateDatabase() *migrate.Migrate {
	...
	driver, err := mysql.WithInstance(conn.DB.DB, &mysql.Config{MigrationsTable: "notification_schema_migrations"})
	m, err := migrate.NewWithDatabaseInstance("file://internal/notification/repository/migrations", "mysql", driver)
	if err != nil {
